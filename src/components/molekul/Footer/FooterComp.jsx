...
const FooterComp = () => {
    return (
        <footer className="text-center lg:text-left bg-gray-100 dark:bg-gray-800 dark:text-gray-400 text-gray-700">
            <div className="flex justify-center items-center lg:justify-between p-6 border-b dark:border-gray-600">
